...
import { Forecast, Location } from './types/weatherTypes';
...
function render(currentWeather: Forecast) {
  console.log("rendering");
  const root = ReactDOM.createRoot(document.getElementById("root") as HTMLElement);
  root.render(
    <React.StrictMode>
...
// once location is defined, need to retrieve weather data for that location
const forecast = await getForecast(currentLocation.coords.latitude, currentLocation.coords.longitude);
